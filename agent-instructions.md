...
- **ALWAYS** update the project's main context document (e.g., `01-context.md`, `README.md`) immediately after:
...
## Project Terminology (this repo)

- **KZ** = Czech abbreviation for *klientská zóna* (client zone). Used in requirements and docs.
